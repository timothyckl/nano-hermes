...
from nano_hermes.providers.registry import ProviderSpec
...
def test_openai_compat_provider_sets_timeout_on_local_http_client() -> None:
    ...
    with (
        patch("nano_hermes.providers.openai_compat_provider.AsyncOpenAI") as mock_async_openai,
        patch(
            "nano_hermes.providers.openai_compat_provider.httpx.AsyncClient",
