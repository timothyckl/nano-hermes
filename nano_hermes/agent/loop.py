...
from nano_hermes.agent.autocompact import AutoCompact
...
from nano_hermes.agent.memory import Consolidator, Dream
from nano_hermes.agent.runner import _MAX_INJECTIONS_PER_TURN, AgentRunner, AgentRunSpec
from nano_hermes.agent.skills import BUILTIN_SKILLS_DIR
from nano_hermes.agent.subagent import SubagentManager
from nano_hermes.agent.tools.ask import (
    AskUserTool,
...
from nano_hermes.agent.tools.spawn import SpawnTool
from nano_hermes.agent.tools.web import WebFetchTool, WebSearchTool
from nano_hermes.bus.events import InboundMessage, OutboundMessage
from nano_hermes.bus.queue import MessageBus
from nano_hermes.command import CommandContext, CommandRouter, register_builtin_commands
...
from nano_hermes.utils.helpers import image_placeholder_text
from nano_hermes.utils.helpers import truncate_text as truncate_text_fn
from nano_hermes.utils.progress_events import (
...
if TYPE_CHECKING:
    from nano_hermes.config.schema import ChannelsConfig, ExecToolConfig, ToolsConfig, WebToolsConfig
...
class _LoopHook(AgentHook):
    ...
    async def on_stream(self, context: AgentHookContext, delta: str) -> None:
        from nano_hermes.utils.helpers import strip_think
...
class AgentLoop:
    ...
    def __init__(
        ...
        from nano_hermes.config.schema import ExecToolConfig, ToolsConfig, WebToolsConfig
    ...
    async def _connect_mcp(self) -> None:
        ...
        from nano_hermes.agent.tools.mcp import connect_mcp_servers
