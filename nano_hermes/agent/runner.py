...
from nano_hermes.agent.tools.ask import AskUserInterrupt
...
from nano_hermes.utils.helpers import (
...
from nano_hermes.utils.runtime import (
...
class AgentRunner:
    ...
    async def _request_model(
        ...
        if timeout_s is None:
            ...
            # Set NANOHERMES_LLM_TIMEOUT_S=0 to disable.
            raw = os.environ.get("NANOHERMES_LLM_TIMEOUT_S", "300").strip()
            try:
                timeout_s = float(raw)
