...
from nano_hermes.agent.tools.schema import BooleanSchema, IntegerSchema, StringSchema, tool_parameters_schema
from nano_hermes.agent.tools import file_state
from nano_hermes.utils.helpers import build_image_content_blocks, detect_image_mime
...
class ReadFileTool(_FsTool):
    ...
    def _read_office_doc(self, fp: Path) -> str:
        from nano_hermes.utils.document import extract_text
