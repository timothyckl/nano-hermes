...
from nano_hermes.cron.types import CronSchedule
...
class Config(BaseSettings):
    ...
    def _match_provider(
        ...
        from nano_hermes.providers.registry import PROVIDERS, find_by_name
    ...
    model_config = ConfigDict(env_prefix="NANOHERMES_", env_nested_delimiter="__")
