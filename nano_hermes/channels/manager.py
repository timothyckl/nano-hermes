...
from nano_hermes.utils.restart import consume_restart_notice_from_env, format_restart_completed_message
...
def _default_webui_dist() -> Path | None:
    ...
    try:
        import nano_hermes.web as web_pkg  # type: ignore[import-not-found]
    except ImportError:
        return None
...
class ChannelManager:
    ...
    Responsibilities:
    - Initialize enabled channels (Telegram, Matrix, Email, Discord, WebSocket)
    - Start/stop channels
